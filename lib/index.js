...
var _webApi = _interopRequireDefault(require("@slack/web-api"));
...
function _default() {
  return {
    ...
    reportTaskStart: function reportTaskStart(startTime, userAgents, testCount) {
      ...
      console.log("Report task start is running now with ".concat(userAgents, "!!!!"));
    },
            ...
            switch (_context.prev = _context.next) {
              case 0:
                ...
                blockBodyMain = [{
                  ...
                  fields: [{
                    type: 'mrkdwn',
                    text: "*Test Tags:*\n@".concat(testTagArray.join(' @').toString())
                  }, {
                    type: 'mrkdwn',
                    text: "*Result:*\n".concat(_this.testResult.failedCount, "/").concat(_this.testCount, " failed")
                  }]
                }, {
                  type: 'divider'
                }];
              ...
              case 8:
                ...
                console.log("Successfully send message in conversation ".concat(conversationId));
